...
$headers .= "From: <web@calquintour.cl>\r\n ";
	...
	$destinatario = "s.gatica.l@gmail.com";
					  ...
					  if ( mail($destinatario, $asunto, $cuerpo,$headers) ) {
                                ...
                                print 'alert("cotizacion enviada, se respondera en menos de 24 horas.");'; 
                                print '</script>'; 
                              
							
							} else {
       						    print '<script language="JavaScript">'; 
                                print 'alert("Envio Fallido, intente nuevamente o utilice las redes sociales para reportarlo.");'; 
                                print '</script>'; 
